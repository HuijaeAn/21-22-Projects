...
(define (enumerate s)
  ...
  (define (enumerate_helper s n) 
    (if (null? s) nil (cons (cons n (cons (car s) nil)) (enumerate_helper (cdr s) (+ n 1))))
  ) 
...
(define (merge inorder? list1 list2)
  ; BEGIN PROBLEM 16
  (cond ((null? list1) 
            (if (null? list2) nil (cons (car list2) (merge inorder? list1 (cdr list2)))))
        ((or (null? list2) (inorder? (car list1) (car list2))) 
